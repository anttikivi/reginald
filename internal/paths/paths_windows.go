...
// ExpandEnv replaces %var%, ${var}, or $var in the string according to the
...
// isShellSpecialVar reports whether the character identifies a special shell
// variable such as $*.
